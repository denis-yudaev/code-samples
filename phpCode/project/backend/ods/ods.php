 ...
 * @param   $className  string  полное строковое представление (fullqualified) класса для автозагрузки функцией __autoload()
 */
	  function($className) {
		  $classMap = [
			    'odsgen\odsFontFace' => 'class/odsFontFace.php',

			    'odsgen\odsStyle'                            => 'class/odsStyle.php',
			    'odsgen\odsStyleNumber'                      => 'class/odsStyle.php',
			    'odsgen\odsStyleTableColumn'                 => 'class/odsStyle.php',
			    'odsgen\odsStyleTable'                       => 'class/odsStyle.php',
			    'odsgen\odsStyleTableRow'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleParagraph'                   => 'class/odsStyle.php',
			    'odsgen\odsStyleTableCell'                   => 'class/odsStyle.php',
			    'odsgen\odsStyleGraphic'                     => 'class/odsStyle.php',
			    'odsgen\odsStyleGraphicGeneric'              => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDash'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashUltrafine'         => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashUltrafineVar'      => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashFine'              => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashUltrafineAndDots'  => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashFineDotted'        => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDashLineAndDot'        => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeDash2Dots1Dash'        => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarker'                => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerArrow'           => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerSquare'          => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerNarrowArrow'     => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerTipRating'       => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerDoubleArrow'     => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerSimetraArrow'    => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerLineArrow'       => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerRondNarrowArrow' => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerCircleArrow'     => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerSquare45'        => 'class/odsStyle.php',
			    'odsgen\odsStyleStrokeMarkerConcaveArrow'    => 'class/odsStyle.php',
			    'odsgen\odsStyleGradient'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient1'           => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient2'           => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient3'           => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient4'           => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient5'           => 'class/odsStyle.php',
			    'odsgen\odsStyleGradientGradient6'           => 'class/odsStyle.php',
			    'odsgen\odsStyleHatch'                       => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlack0Degrees'          => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlack45Degrees'         => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlackLess45Degrees'     => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlack90Degrees'         => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchRedCrossed45Degrees'    => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchRedCrossed0Degrees'     => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlueCrossed45Degrees'   => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlueCrossed0Degrees'    => 'class/odsStyle.php',
			    'odsgen\odsStyleHatchBlueTriple90Degrees'    => 'class/odsStyle.php',
			    'odsgen\odsStyleFillImage'                   => 'class/odsStyle.php',
			    'odsgen\odsStyleMoney'                       => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyEUR'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyEURNeg'                 => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyUSD'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyUSDNeg'                 => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyGBP'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleMoneyGBPNeg'                 => 'class/odsStyle.php',
			    'odsgen\odsStyleDate'                        => 'class/odsStyle.php',
			    'odsgen\odsStyleDateMMDDYYYY'                => 'class/odsStyle.php',
			    'odsgen\odsStyleDateMMDDYY'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDDMMYYYY'                => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDDMMYY'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDMMMYYYY'                => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDMMMYY'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDMMMMYYYY'               => 'class/odsStyle.php',
			    'odsgen\odsStyleDateDMMMMYY'                 => 'class/odsStyle.php',
			    'odsgen\odsStyleDateMMMDYYYY'                => 'class/odsStyle.php',
			    'odsgen\odsStyleDateMMMDYY'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleTime'                        => 'class/odsStyle.php',
			    'odsgen\odsStyleTimeHHMMSS'                  => 'class/odsStyle.php',
			    'odsgen\odsStyleTimeHHMM'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleTimeHHMMSSAMPM'              => 'class/odsStyle.php',
			    'odsgen\odsStyleTimeHHMMAMPM'                => 'class/odsStyle.php',
			    'odsgen\odsStyleDateTime'                    => 'class/odsStyle.php',
			    'odsgen\odsStyleDateTimeMMDDYYHHMMSSAMPM'    => 'class/odsStyle.php',
			    'odsgen\odsStyleDateTimeMMDDYYHHMMAMPM'      => 'class/odsStyle.php',
			    'odsgen\odsStyleDateTimeDDMMYYHHMMSS'        => 'class/odsStyle.php',
			    'odsgen\odsStyleDateTimeDDMMYYHHMM'          => 'class/odsStyle.php',

			    'odsgen\odsTable' => 'class/odsTable.php',

			    'odsgen\odsTableColumn'          => 'class/odsTableColumn.php',
			    'odsgen\odsTableColumnWithWidth' => 'class/odsTableColumn.php',

			    'odsgen\odsTableRow' => 'class/odsTableRow.php',

			    'odsgen\odsTableCell'            => 'class/odsTableCell.php',
			    'odsgen\odsTableCellEmpty'       => 'class/odsTableCell.php',
			    'odsgen\odsCoveredTableCell'     => 'class/odsTableCell.php',
			    'odsgen\odsTableCellStringHttp'  => 'class/odsTableCell.php',
			    'odsgen\odsTableCellString'      => 'class/odsTableCell.php',
			    'odsgen\odsTableCellStringEmail' => 'class/odsTableCell.php',
			    'odsgen\odsTableCellStringUrl'   => 'class/odsTableCell.php',
			    'odsgen\odsTableCellFloat'       => 'class/odsTableCell.php',
			    'odsgen\odsTableCellCurrency'    => 'class/odsTableCell.php',
			    'odsgen\odsTableCellDate'        => 'class/odsTableCell.php',
			    'odsgen\odsTableCellTime'        => 'class/odsTableCell.php',
			    'odsgen\odsTableCellDateTime'    => 'class/odsTableCell.php',
			    'odsgen\odsTableCellDraw'        => 'class/odsTableCell.php',
			    'odsgen\odsTableCellImage'       => 'class/odsTableCell.php',
			    'odsgen\odsTableCellComplex'     => 'class/odsTableCell.php',

			    'odsgen\odsSpan'        => 'class/odsTextElement.php',
			    'odsgen\odsParagraph'   => 'class/odsTextElement.php',
			    'odsgen\odsTextElement' => 'class/odsTextElement.php',

			    'odsgen\odsStyleText'      => 'class/odsStyleText.php',
			    'odsgen\odsTextProperties' => 'class/odsStyleText.php',

			    'odsgen\odsDraw'      => 'class/odsDraw.php',
			    'odsgen\odsDrawLine'  => 'class/odsDraw.php',
			    'odsgen\odsDrawRect'  => 'class/odsDraw.php',
			    'odsgen\odsDrawImage' => 'class/odsDraw.php'
		  ];

		  if ( array_key_exists( $className, $classMap ) ) {
			  require_once __DIR__ . DIRECTORY_SEPARATOR . $classMap[ $className ] ;
		  }
	  });
...
// require_once('class/odsTextElement.php');
// require_once('class/odsStyleText.php');
...
class ods {
	...
	private $inlineAutomaticStyles;
	private $inlineSpreadsheet;
	private $inlineXmlContent;
	...
	public function __construct() {
		...
		$this->addFontFaces( new odsFontFace( 'Times New Roman', 'roman' ) );
		...
		$this->defaultStyle = new odsStyleTableCell('Default');
	}
	...
	protected static function quote(\DOMDocument $dom)
	{
	...
	//  инлайн значения тэгов office:spreadsheet и style:automatic-styles XML-файла content:

	public function setInlineAutomaticStyles($string) {
		$this->inlineAutomaticStyles = $string;
	}
	public function setInlineSpreadsheet($string) {
		$this->inlineSpreadsheet = $string;
	}
	public function setInlineXmlContent($string) {
		$this->inlineXmlContent = $string;
	}

	public function getInlineAutomaticStyles() {
		return $this->inlineAutomaticStyles;
	}
	public function getInlineSpreadsheet() {
		return $this->inlineSpreadsheet;
	}
	public function getInlineXmlContent() {
		return $this->inlineXmlContent;
	}
	...
	public function addStyles($styles){
		// $this->loopIfArray($styles, 'addStyle');
	...
	public function addStyle(odsStyle $odsStyle) {
	...
	public function getContent() {
		...
		$xmlContent = $this->getInlineXmlContent();
		...
		$root = $dom->createElement('office:document-content');
			...
			$root->setAttribute('grddl:transformation', 'http://docs.oasis-open.org/office/1.2/xslt/odf2rdf.xsl');
		...
		$office_automatic_styles =  $dom->createElement('office:automatic-styles');
			...
			//  если передать строку в свойство self::inlineAutomaticStyles, то эта строка станет содержимым тэга
			//  office:automatic-styles.
			$inlineAutomaticStyles = $this->getInlineAutomaticStyles();

			if ( $inlineAutomaticStyles )
			{
				$office_automatic_styles->textContent = $inlineAutomaticStyles;

			} else
			{
				foreach($this->styles as $_style) {
					$office_automatic_styles->appendChild( $_style->getContent( $this, $dom ) );
				}
			}
			...
			$inlineSpreadsheet = $this->getInlineSpreadsheet();

			if ( $inlineSpreadsheet )
			{
				$office_spreadsheet->textContent = $inlineSpreadsheet;
	...
	public function getMeta() {
		...
		$meta->appendChild($dom->createElement('meta:generator','ods generator'));
	...
	public function getStyles() {
		...
		/** office:font-face-decls
		 * @var \DOMElement $office_font_face_decls корневой контейнер шрифтов
		 */
			$office_font_face_decls =  $dom->createElement('office:font-face-decls');
			$root->appendChild($office_font_face_decls);
			...
			/** office:styles
			 *  @var \DOMElement $office_styles корневой контейнер, содержащий описание основных базовых стилей, стилей по-умолчанию, и стилей,
			 *  объявленных и сохранённых пользователем в таблице стилей документа.
			 */
			$office_styles = $dom->createElement( 'office:styles' );
				...
				$style_default_style = $dom->createElement('style:default-style');
					...
					$style_text_properties =  $dom->createElement('style:text-properties');
						...
						$style_text_properties->setAttribute('style:font-size-asian', $this->defaultFontSize ?: '12pt');
						$style_text_properties->setAttribute('style:language-asian', 'zxx');
						$style_text_properties->setAttribute('style:country-asian', 'none');
						$style_text_properties->setAttribute('style:font-size-complex', $this->defaultFontSize ?: '12pt');
						$style_text_properties->setAttribute('style:language-complex', 'zxx');
						$style_text_properties->setAttribute('style:country-complex', 'none');
						$style_default_style->appendChild($style_text_properties);
				...
				//  Default style definition
		   		$style_style = $this->defaultStyle->getContent( $this, $dom );
			...
			/** office:automatic-styles
			 *  @var \DOMElement $office_automatic_styles корневой контейнер системных стилей типа style:page-layout (может включать и другие описания)
			 *  TODO: описание будет дополнено
			 */
			 ...
			 *  @var \DOMElement $office_master_styles корневой контейнер «master-стилей» документа содержит описание элементов типа style:master-page
			 *  TODO: описание будет дополнено
			 */
			$office_master_styles = $dom->createElement( 'office:master-styles' );
				...
				$style_master_page = $dom->createElement('style:master-page');
					...
					$style_header->setAttribute('style:display', 'false');
					...
					$style_footer = $dom->createElement('style:footer');
						...
						$text_p = $dom->createElement('text:p', 'Страница');
	...
	public function genOdsFile($filename)
	{
		$zip = new \ZipArchive();
	...
	public function downloadOdsFile($fileName) {
		...
		readfile($tmpfile);
		unlink($tmpfile);
		exit(0);  // фикс для загрузки шаблона импорта
	}
